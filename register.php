                            ...
                            <form class="user" action="register_db.php" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        name="password_1" id="password_1" placeholder="password">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            name="password_2" id="password_2" placeholder="Confirm password">
                                    </div>
                                </div>
                                <!-- <a href="login.php" name="reg_user"class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a> -->
                                <div >
